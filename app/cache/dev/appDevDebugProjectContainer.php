...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_user.registration.form.type' => 'getOcUser_Registration_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'OCWebApp', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/OC/EPIBundle/Entity'), 1 => ($this->targetDirs[3].'/src/OC/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'OC\\EPIBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('OCEPIBundle' => 'OC\\EPIBundle\\Entity', 'OCUserBundle' => 'OC\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4eb5b514d9432631950e0e239c3156f2b1d2f8728f96e040eeb0ba0d8153f34b');
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'oc_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    /**
     * Gets the 'oc_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\UserBundle\Form\Type\RegistrationFormType A OC\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getOcUser_Registration_Form_TypeService()
    {
        return $this->services['oc_user.registration.form.type'] = new \OC\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, 'oc_epi_index'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $n->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/epi', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/OC/EPIBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/WebSiteBundle/Resources/translations/header.de.yml'), 'de', 'header');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/WebSiteBundle/Resources/translations/header.en.yml'), 'en', 'header');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/WebSiteBundle/Resources/translations/header.fr.yml'), 'fr', 'header');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/WebSiteBundle/Resources/translations/index.fr.yml'), 'fr', 'index');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/OC/EPIBundle/Resources/views'), 'OCEPI');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/OC/UserBundle/Resources/views'), 'OCUser');
        $instance->addPath(($this->targetDirs[3].'/src/WebSiteBundle/Resources/views'), 'WebSite');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OCEPIBundle' => 'OC\\EPIBundle\\OCEPIBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'OCUserBundle' => 'OC\\UserBundle\\OCUserBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'WebSiteBundle' => 'WebSiteBundle\\WebSiteBundle',
            ...
            'fos_user.registration.form.type' => 'oc_user_registration',
